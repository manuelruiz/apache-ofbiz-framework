...
public final class UtilDateTime {
    ...
    /**
     * Return Timestamp for right now minus minutes param
     * 
     * @param minutes
     * @return Timestamp for right now minus minutes param
     */
    public static java.sql.Timestamp nowTimestampMinusMin(int minutes){
	    Date now = new Date();
	    Timestamp ts = new Timestamp(now.getTime());
	    GregorianCalendar cal = new GregorianCalendar();
	    cal.setTimeInMillis(ts.getTime());
	    cal.add(cal.MINUTE, - minutes);
	    return getTimestamp(cal.getTimeInMillis());
    }
